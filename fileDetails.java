...
class fileDetails
{
  public static void main(String args[])
   {
    File f1=new File("C:\\Users\\Remin\\Desktop\\remin\\java\\packages");
    if (f1.isDirectory())
     {
       ...
       for(int i=0;i<s.length;i++)
        {
           File f2=new File("C:\\Users\\Remin\\Desktop\\remin\\java\\packages"+"\\"+s[i]);
           if (f2.isDirectory())
       ...
       System.out.println("C:\\Users\\Remin\\Desktop\remin\\java\\packages"+" is not a directory");
     ...
     for(int i=0;i<filelist.length;i++)
      {
        File f2=new File("C:\\Users\\Remin\\Desktop\\remin\\java\\packages"+"//"+filelist[i]);
...
/* output:
>java fileDetails
Details of :C:\Users\Remin\Desktop\remin\java\packages
Total No.of files :6
